    ...
    return (
        <section className="grid grid-cols-12 mx-10 gap-x-28">
            ...
            <div className="col-span-6 mr-12 flex flex-col justify-center items-start">
                <p className="font-medium">Hi, I'm Sandra Lyons</p>
                <p className="text-7xl font-semibold mt-6">
                ...
                <button className="bg-primary text-white text-sm font-semibold p-5 pl-3 rounded-md">
                    {"> "}
                    <span className="pl-2">ONLINE COACHING</span>
                </button>
            </div>
        </section>
    );
