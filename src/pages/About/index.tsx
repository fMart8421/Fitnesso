...
const About = () => {
    return (
        <main className="">
            <section className="relative bg-[#d2e4e0] grid grid-cols-2 gap-16 pt-44 pb-16 px-10 z-0">
            ...
            <FadeUpWrapper>
                <section className="px-10 flex flex-col items-center py-32">
                    ...
                    <div className="relative cursor-pointer z-0 group">
                        ...
                        />
                        <span className="group-hover:bg-white/30 transition z-10 absolute top-0 left-0 w-full h-full rounded-xl"></span>
                        <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-10 rounded-full border-2 bg-white/30 hover:bg-white/50 hover:scale-105 transition-all border-white z-20">
                            <img
                                className="h-[30px]"
            ...
            <section className="relative pl-10 grid grid-cols-2 gap-32 pt-36 pb-32 mt-16">
                ...
                <FadeUpWrapper className="justify-self-center w-4/5">
                    <img
            ...
            <section className="relative pr-10 grid grid-cols-2 gap-32 pt-36 pb-32">
                ...
                <FadeUpWrapper>
                    <div className="my-16">
                        ...
                        <h3 className="font-medium text-xl max-w-[65%] my-6">
                            Lorem ipsum dolor but on the other side, consectetur
